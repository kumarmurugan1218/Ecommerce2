...
const Product = () => {
  ...
  return (
    <section className='min-h-screen w-full  grid place-items-center place-content-center gap-y-10 py-10'>
    <h1 className='heading mt-5 '>Products</h1>
    <div className="grid w-full grid-cols-1 gap-30 px-10  place-items-center place-content-center  md:grid-cols-3 ">
